// Generated by Bisonc++ V4.09.02 on Mon, 05 Dec 2016 15:48:53 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {289, 5}, // 1: start (OPENBRAC) ->  szignatura OPENBRAC deklaraciok torzs CLOSEBRAC
     {290, 4}, // 2: szignatura (INT) ->  INT MAIN OPENPAR CLOSEPAR
     {291, 0}, // 3: deklaraciok ->  <empty>
     {291, 2}, // 4: deklaraciok ->  deklaracio deklaraciok
     {293, 3}, // 5: deklaracio (UNSIGNED) ->  UNSIGNED ID ENDL
     {293, 3}, // 6: deklaracio (BOOL) ->  BOOL ID ENDL
     {292, 1}, // 7: torzs ->  utasitas
     {292, 2}, // 8: torzs ->  utasitas torzs
     {294, 1}, // 9: utasitas ->  ertekadas
     {294, 1}, // 10: utasitas ->  be
     {294, 1}, // 11: utasitas ->  ki
     {294, 1}, // 12: utasitas ->  elagazas
     {294, 1}, // 13: utasitas ->  ciklus
     {295, 4}, // 14: ertekadas (ID) ->  ID EQV kifejezes ENDL
     {296, 4}, // 15: be (STR_IN) ->  STR_IN CIN ID ENDL
     {297, 4}, // 16: ki (STR_OUT) ->  STR_OUT COUT kifejezes ENDL
     {298, 7}, // 17: elagazas (IF) ->  IF OPENPAR kifejezes CLOSEPAR OPENBRAC torzs CLOSEBRAC
     {298, 11}, // 18: elagazas (IF) ->  IF OPENPAR kifejezes CLOSEPAR OPENBRAC torzs CLOSEBRAC ELSE OPENBRAC torzs CLOSEBRAC
     {299, 7}, // 19: ciklus (WHILE) ->  WHILE OPENPAR kifejezes CLOSEPAR OPENBRAC torzs CLOSEBRAC
     {300, 1}, // 20: kifejezes (NUM) ->  NUM
     {300, 1}, // 21: kifejezes (TRUE) ->  TRUE
     {300, 1}, // 22: kifejezes (FALSE) ->  FALSE
     {300, 1}, // 23: kifejezes (ID) ->  ID
     {300, 3}, // 24: kifejezes (PLS) ->  kifejezes PLS kifejezes
     {300, 3}, // 25: kifejezes (MIN) ->  kifejezes MIN kifejezes
     {300, 3}, // 26: kifejezes (MUL) ->  kifejezes MUL kifejezes
     {300, 3}, // 27: kifejezes (DIV) ->  kifejezes DIV kifejezes
     {300, 3}, // 28: kifejezes (MOD) ->  kifejezes MOD kifejezes
     {300, 3}, // 29: kifejezes (LESS) ->  kifejezes LESS kifejezes
     {300, 3}, // 30: kifejezes (GRT) ->  kifejezes GRT kifejezes
     {300, 3}, // 31: kifejezes (EQUAL) ->  kifejezes EQUAL kifejezes
     {300, 3}, // 32: kifejezes (AND) ->  kifejezes AND kifejezes
     {300, 3}, // 33: kifejezes (OR) ->  kifejezes OR kifejezes
     {300, 2}, // 34: kifejezes (NEG) ->  NEG kifejezes
     {300, 3}, // 35: kifejezes (OPENPAR) ->  OPENPAR kifejezes CLOSEPAR
     {301, 1}, // 36: start_$ ->  start
};
