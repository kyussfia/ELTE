// Generated by Bisonc++ V4.09.02 on Mon, 21 Nov 2016 19:12:03 +0100
...
#line 69 "assign.y"
        {
         if( szimbolumtabla.find(*d_vsp__[-2].szoveg) == szimbolumtabla.end())
         { 
         std::stringstream ss;
         ss << "Nem deklaralt valtozo: " << *d_vsp__[-2].szoveg << ".\n" << std::endl;
         error( ss.str().c_str() );
         }
         if( szimbolumtabla[*d_vsp__[-2].szoveg].var_type != *d_vsp__[0].tipus)
         {
         error( "Tipushibas ertekadas.\n" );
         }
         delete d_vsp__[-2].szoveg;
         delete d_vsp__[0].tipus;
         }
        break;
...
#line 87 "assign.y"
        {
         if( szimbolumtabla.find(*d_vsp__[0].szoveg) == szimbolumtabla.end())
         { 
         std::stringstream ss;
         ss << "Nem deklaralt valtozo: " << *d_vsp__[0].szoveg << ".\n" << std::endl;
         error( ss.str().c_str() );
         }
         d_val__.tipus = new typee(szimbolumtabla[*d_vsp__[0].szoveg].var_type);
         delete d_vsp__[0].szoveg;
         }
        break;
...
#line 99 "assign.y"
        {
         d_val__.tipus = new typee(natural);
         }
        break;
...
#line 104 "assign.y"
        {
         d_val__.tipus = new typee(boolean);
         }
        break;
