...
namespace ELTE.TravelAgency.Models
{
	...
	public static class DbInitializer
	{
		...
		{
			_context = app.ApplicationServices.GetRequiredService<TravelAgencyContext>();
		...
		private static void SeedBuildings()
		{
			var buildings = new Building[]
			{
				new Building
				{
					...
					CityId = 1,
					SeaDistance = 100,
					ShoreId = ShoreType.Sandy,
					LocationX = 45.4591,
					LocationY = 12.5068,
					Comment =
						"Szállás bungallóban 100m strandtól (homokos tengerpart). A területen található étterem, bár, játszótér. Éjszakai nyugalmat betartani. Ott-tartózkodás szombattól szombatig. A szállásszolgáltató beszél is csehül. Parkoló - nem őrzött, ingyenes. Busz 100m. Vonat (állomás San Dona di Piave) 25km. Repülőtér (Venezia - Marco Polo) 40km. Cavallino - központ.')",
				},
				new Building
				{
		...
		private static void SeedApartments()
		{
			var apartments = new Apartment[]
			{
				new Apartment
				{
					...
					Comment =
						"2x2-ágyas szoba, nappali két pótággyal (szétnyitható heverő), fürdőszoba zuhanyozófülkével és WC-vel, konyha (gáztűzhely, hűtőszekrény), étkezősarok.",
					Price = 21
				},
				new Apartment
				{
				...
				new Apartment
				{
					...
					Turnday = DayOfWeek.Saturday,
					Comment =
						"2x2-ágyas szoba, TV, nappali két pótággyal, fürdőszoba zuhanyozófülkével és WC-vel, konyha (gáztűzhely, hűtőszekrény), étkezősarok",
					Price = 28
				},
				new Apartment
				{
				...
				new Apartment
				{
					...
					Turnday = DayOfWeek.Sunday,
					Comment =
						"2x2-ágyas szoba, fürdőszoba zuhanyozófülkével és WC-vel, telefon, erkély, műholdas TV, nappali, kis konyha",
					Price = 54
				},
				new Apartment
				{
		...
		private static async void SeedBuildingImages(string imageDirectory)
		{
