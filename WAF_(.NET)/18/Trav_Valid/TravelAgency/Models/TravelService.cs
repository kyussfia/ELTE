...
namespace ELTE.TravelAgency.Models
{
    ...
    public class TravelService : ITravelService
    {
	    ...
	    private RentDateValidator _rentDatValidator;

        public TravelService(TravelAgencyContext context)
        {
	        _context = context;
			_rentDatValidator = new RentDateValidator(_context);
        }
        ...
        public Boolean SaveRent(Int32? apartmentId, RentViewModel rent)
        {
            ...
            if (_rentDatValidator.Validate(rent.RentStartDate, rent.RentEndDate, apartmentId.Value) != RentDateError.None)
                return false;
