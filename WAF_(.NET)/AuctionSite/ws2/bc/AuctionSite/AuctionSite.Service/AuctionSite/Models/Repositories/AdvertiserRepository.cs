...
namespace AuctionSite.Models.Repositories
{
    public class AdvertiserRepository : BaseEntityRepo
    {
        ...
        public Task<Boolean> LoginAdvertiserPwd(String username, String pwd)
        {
            Entities.Advertiser guest = GetAdvertiserByUsername(username);
            ...
            return Task.FromResult(checkPassword(pwd, guest.Password));
        }
