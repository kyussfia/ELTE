...
int main(int argc, char* argv[])
{
	...
	for (multimap<string,int>::iterator it = votes.begin(), end = votes.end(); it != end; it = votes.upper_bound(it->first), ++counter_m) {
	...
	ofstream myfile;
 	...
 	string currentKey = "";
 	for (multimap<string,int>::iterator it = result.begin(), end = result.end(); it != end; ++it) {
