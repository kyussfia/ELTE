...
namespace LightDuel_WinForms.Model
{
    ...
    public class LightDuelModel
    {
        ...
        {
            baseTimer = new System.Windows.Forms.Timer();
            baseTimer.Interval = this.speed;
            this.baseTimer.Tick += BaseTimer_Tick;
        }
